              ...
              {links.map((link, index) => {
                ...
                return (
                  <a
                    ...
                    className="group p-5 rounded-lg border border-border bg-background hover:bg-accent transition-all duration-500 hover-lift cursor-pointer"
                    style={getItemStyle(index)}
                  >
                    {isEmailLink && copied ? (
                      <Check className="h-5 w-5 text-green-500 mb-3 transition-all duration-500 scale-110" />
                    ) : (
                      <link.icon className="h-5 w-5 text-muted-foreground mb-3 group-hover:text-foreground group-hover:scale-110 transition-all duration-500" />
                    )}
                    <p className="font-medium group-hover:text-foreground transition-colors duration-500">
